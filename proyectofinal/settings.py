...
SECRET_KEY = 'l(%-pv4b$+g3x4mdt#6^%p^ujm)#qoga!r1((bp*ai!-(*!a0)'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['C:/Users/pablo.cardona/Desktop/Universidad/html/djangoproject/proyectofinal/proyectofinal/templates/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
